...
# Original DoubleConv kept here for reference.
...
class UNet2D(nn.Module):
    def __init__(self, in_channels: int = 1, num_classes: int = 4, features: tuple[int, ...] = (32, 64, 128, 256)) -> None:
        ...
        for feature in features:
            self.down_blocks.append(ResidualBlock(current_channels, feature))
        ...
        for feature in reversed(features):
            ...
            self.up_blocks.append(ResidualBlock(feature * 2, feature))
            current_channels = feature
