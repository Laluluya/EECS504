...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run RV area-curve extraction for every testing patient.")
    parser.add_argument("--checkpoint", type=Path, required=True)
    parser.add_argument("--data-root", type=Path, default=Path("testing"))
    parser.add_argument("--output-dir", type=Path, default=Path("runs/testing_rv_curves"))
